...
void PlayDemo(int argc, char** argv)
{
	...
	titleLabel.setContent("Fish GUI 1.0.0.0");
	...
	btSetText.setCaption("SetContext");
	...
	btGetText.setCaption("GetContext");
	btGetText.setSelectable(true);
	Rect rectGetText;
	rectGetText.nWidth = 12;
